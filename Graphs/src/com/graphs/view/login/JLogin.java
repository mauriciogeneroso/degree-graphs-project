...
public class JLogin extends javax.swing.JFrame {
    ...
    private void jbEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEntrarActionPerformed
        if (jtxtUsername.getText().trim().equals("")) {
            ...
            com.graphs.util.LoadSettings.setUsuario(jtxtUsername.getText());
            try {
                for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                    if ("Nimbus".equals(info.getName())) {
                        javax.swing.UIManager.setLookAndFeel(info.getClassName());
                ...
                com.graphs.util.MessageCtrl.callMessage(ex.getMessage(), "Erro!", 8);
            }
            if (jcbSave.isSelected()) {
                com.graphs.util.LoadSettings.setSaveUsername(true);
            } else {
                com.graphs.util.LoadSettings.setSaveUsername(false);
            }
