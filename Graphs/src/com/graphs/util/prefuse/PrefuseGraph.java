package com.graphs.util.prefuse;
...
public class PrefuseGraph extends JFrame {
    ...
    public static void showGraficMode() {
        ...
        javax.swing.ImageIcon img = new javax.swing.ImageIcon(frame.getClass().getResource(com.graphs.util.Constants.PATH_TO_ICON_FOLDER + "icon.png"));
