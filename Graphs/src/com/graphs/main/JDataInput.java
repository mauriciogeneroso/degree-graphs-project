...
public class JDataInput extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        entradaNos.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        entradaArestas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        rButtonCompleto.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        rButtonDefinir.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        buttonDefinirAdjacencia.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        buttonCriarGrafo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/graphs/util/images/ic_save.png"))); // NOI18N
        buttonCriarGrafo.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        buttonCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/graphs/util/images/ic_exit.png"))); // NOI18N
        ...
        buttonLimpar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/graphs/util/images/ic_clear.png"))); // NOI18N
        buttonLimpar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void rButtonDefinirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rButtonDefinirActionPerformed
        if (entradaNos.getText().equals("")) {
            ...
            rButtonCompleto.setSelected(true);
            com.graphs.util.MessageCtrl.callMessage("Informe os Nós para definir", "Aviso", 2);
            LOG.put("JDataInput", "rButtonDefinirActionPerformed", 0, "Informe os nós para definir");
        } else if (nodeRepeated()) {
            rButtonDefinir.setSelected(false);
            rButtonCompleto.setSelected(true);
            com.graphs.util.MessageCtrl.callMessage("Existem nós com o mesmo nome", "Aviso", 2);
    ...
    private void entradaArestasFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_entradaArestasFocusLost
        ...
        if (entradaArestas.getText().equals("")) {
            com.graphs.util.MessageCtrl.callMessage("Informe as Arestas para definir o grafo", "Aviso", 2);
            LOG.put("JDataInput", "entradaArestasFocusLost", 0, "Informe as Arestas para definir o grafo");
        } else if (edgeRepeated()) {
            com.graphs.util.MessageCtrl.callMessage("Existem arestas com o mesmo nome", "Aviso", 2);
            ...
            try {
                ...
                com.graphs.util.MessageCtrl.callMessage("Valores inválidos para as Arestas informadas", "Aviso", 8);
    ...
    private void buttonCriarGrafoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCriarGrafoActionPerformed
        if (rButtonDefinir.isSelected()) {
            ...
            com.graphs.util.MessageCtrl.callMessage("É necessário informar os nós para criar o grafo", "Aviso", 2);
        } else {
            // CRIA AUTOMATICAMENTE O GRAFO COMPLETO
            graph2.setNodes(captureNodes(entradaNos.getText()));

            if (graph2.countNode() == 1) {
                com.graphs.util.MessageCtrl.callMessage("Não é posśivel criar um grafo completo com apenas um nó", "Aviso", 2);
