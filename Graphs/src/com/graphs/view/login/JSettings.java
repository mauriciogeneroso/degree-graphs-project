...
public class JSettings extends javax.swing.JFrame {
    ...
    public JSettings() {
        initComponents();
        javax.swing.ImageIcon img = new javax.swing.ImageIcon(getClass().getResource(com.graphs.util.Constants.PATH_TO_ICON_FOLDER + "icon.png"));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        jtxtUsername.setText(com.graphs.util.LoadSettings.getUsuario());
        if (com.graphs.util.LoadSettings.isUsernameSave()) {
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        com.graphs.main.JMainWindow fm = new com.graphs.main.JMainWindow();
        fm.setVisible(true);
        LOG.put("JSettings", "formWindowClosing", "Fechada com sucesso");
    }//GEN-LAST:event_formWindowClosing

    private void jbRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbRemoverActionPerformed
        com.graphs.util.LoadSettings.resetUsername();
        com.graphs.util.MessageCtrl.callMessage("Usuário resetado com sucesso!", "Sucesso!", 7);
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        ...
        if (username.trim().equals("")) {
            com.graphs.util.MessageCtrl.callMessage("Ei, informe corretamente!", "Aviso!", 2);
            ...
            com.graphs.util.MessageCtrl.callMessage("Usuário \"" + username + "\" salvo com sucesso!", "Sucesso!", 7);
            LOG.put("JSettings", "jbRemoverActionPerformed", 2, "Usuário \"" + username + "\" salvo com sucesso");
            com.graphs.util.LoadSettings.setUsuario(username);
        }
